...
我主导了 **Xinyuan-LLM、Xinyuan-VL、MindChat、Sunsimiao、ColugoMum** 与 **OXiaoPeng** 等项目；个人参与及主导的开源项目在 GitHub 累计获得 **20000+ Stars**，多次进入 GitHub Trending；出版大模型应用图书 **1** 本，发表论文 **4** 篇，获授权专利与软件著作权共 **4** 项；获国家级奖项 **7** 项、省市级奖项 **10 余项**。
