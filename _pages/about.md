...
* **主导 Xinyuan 系列垂域大模型全链路研发**: 覆盖**400万+** 多源数据治理(脱敏/去重/质量打分)、增量预训练、SFT、RLHF 与多维度评测, 系列开源模型在 **HuggingFace + ModelScope** 双平台累计下载 **2万+**.
* **推动多模态大模型与具身智能前沿落地**:
  * *2024.10*: &nbsp; 🎉🎉 主导发布 [Xinyuan-VL-2B](https://huggingface.co/Cylingo/Xinyuan-VL-2B), 登顶当时 [OpenCompass](https://huggingface.co/spaces/opencompass/open_vlm_leaderboard) **<4B参数榜首**.
  * *2025.04*: &nbsp; 🎉🎉 主导发布 [Xinyuan-LLM-14B-0428](https://huggingface.co/Cylingo/Xinyuan-LLM-14B-0428), 打造 **世界首个泛心理+教育领域基座模型**.
* **代表团队对外输出技术影响力**:
  * *2025.05*: &nbsp; 🎉🎉 受邀于 **阿里云魔搭 ModelScope 开发者共创会** 分享《**开源技术驱动下的泛心理服务与AI普惠实践之路**》.
  * *2025.07*: &nbsp; 🎉🎉 接受 **阿里云通义实验室 & 魔搭 ModelScope 社区** 联合专访 \| [\[文章\]](https://mp.weixin.qq.com/s/a16sWs_QPtvoeY4J5eexTg)、[\[视频\]](https://www.bilibili.com/video/BV1GVgNzLEHs/?share_source=copy_web)、[\[音频\]](https://www.xiaoyuzhoufm.com/episodes/6878c7f5a9dec92500c5c93e).
...
* 【数聚凤巢】2022年第8届南京财经大学"互联网+"大学生创业计划大赛 <strong>一等奖</strong> \| [\[点击\]]()
* 【袋鼯麻麻】2022年第8届华东理工大学"互联网+"大学生创业计划大赛 <strong>一等奖</strong> \| [\[点击\]]()
...
# ✨ Honors 
* 2022年国家级大学生创新创业项目 <strong>第一主持人</strong> <strong>优秀 结题</strong> \| [\[点击\]](http://gjcxcy.bjtu.edu.cn/NewLXItemListForStudentDetail.aspx?ItemNo=941768&year=2022&type=student&IsLXItem=0)
* 百度飞桨开发者技术专家 \| [\[点击\]](https://www.paddlepaddle.org.cn/ppdemd?n=/ppdemd/%E9%A2%9C%E9%91%AB)
* 英特尔创新大使 \| [\[点击\]]()
* OpenI启智社区首批核心体验官 \| [\[点击\]](https://openi.org.cn/index.php?m=content&c=index&a=show&catid=221&id=53)
...
* OpenI启智社区活跃开发者 \| [\[点击\]](/proof/OpenI%E6%B4%BB%E8%B7%83%E5%BC%80%E5%8F%91%E8%80%85%E2%80%94%E9%A2%9C%E9%91%AB.jpg)
...
* 主导构建**健康大模型知识中台**, 打通从基础层到应用层的端到端矩阵. 基于 SimHash、Perplexity 等技术对**百万级医疗数据**与**十万级心理对话数据**(总量 **400万+**)完成**脱敏 / 去重 / 质量打分**; 在 Qwen、InternLM 等开源大语言模型基础上, 通过**增量预训练 + SFT + RLHF** 三阶段精调, **双轨驱动**孵化 <a href="https://github.com/X-D-Lab/Sunsimiao">医疗大模型孙思邈 (Sunsimiao)</a> 与 <a href="https://github.com/X-D-Lab/MindChat">心理大模型漫谈 (MindChat)</a>; 引入 **RAG** 架构, 基于 <a href="https://github.com/thomas-yanxin/LangChain-ChatGLM-Webui">LangChain + 向量数据库</a> 构建**长时 / 角色 / 知识** 三维记忆体系, 有效规避大模型幻觉; 最终通过 [欧小鹏 OXiaoPeng](https://github.com/thomas-yanxin/OXiaoPeng) 部署至微信生态, 实现对用户**全方位、全时域、全场景**的心理与健康支持.
</div>
</div>
...
* 主导研发 **ColugoMum 智能零售结算平台**, 突破传统目标检测算法在零售场景下**成本高、训练难**的瓶颈, 自研新型零售商品识别算法, 针对无人零售场景**多类别、小样本、高相似度、高频更新**等行业痛点提供可复用的视觉智能解决方案. 项目斩获**2022 年第 24 届中国机器人及人工智能大赛全国一等奖**, 受邀亮相**百度 Wave Summit 2021+ 开发者峰会市集展览**(累计浏览 **10万+**), **入选启智社区优秀开源项目孵化器**并获**2022 年启智社区优秀孵化项目奖**, 同步落地**教育部产学合作协同育人项目(百度 & 华东理工大学)课程建设成果**.
</div>
</div>
...
* 主导构建多模型聚合应用 **欧小鹏 OXiaoPeng**, 统一对接百度文心 ERNIE、鹏程·盘古 PanGu、浪潮源 Yuan1.0、元语智能 ChatYuan、ChatGPT 等主流大模型, 以微信、飞书、QQ 为前端载体, **以用户体验作为大模型的评价标尺, 打造大模型试炼场**, 提供文生图、对话、领域知识库自动问答等能力, 加速大模型在真实社区运营中的落地.
* 项目沉淀**直接用户 2000+、间接覆盖用户 2万+**, 服务 OpenI 启智社区、鹏程·盘古、元语智能、飞桨领航团等多个 AI 社区. **入围 2023 年奇绩春季创业营 (S23) 面试**, 荣获 **2022 年启智社区优秀孵化项目奖**.
...
* 2020年及2021年华东理工大学新生迎新活动作为迎新志愿者 \| [\[点击\]](./个人经历相关材料/迎新志愿者.jpg)
* 2021年上海市献血活动无偿献血 \| [\[点击\]]()
...
# 💬 Invited Talks
* *2023.06*, 【飞桨PaddlePaddle-大模型应用开发课】全流程构建智能文档查询助手 \| [\[视频\]](https://www.bilibili.com/video/BV18h4y1d77H/?share_source=copy_web&vd_source=8162f92b2a1a94035ca9e4e0f6e1860a)
...
* 统筹飞桨领航团**华东七省(山东、安徽、江苏、上海、浙江、江西、台湾)** 全域运营, 主导高校拓展、团长选拔、活动策划与项目落地. 任期内**新增覆盖高校 50+ 所**, 涵盖浙江大学、东南大学、上海科技大学、南京航空航天大学、苏州大学、华东理工大学、合肥工业大学等一系列国家重点高校, 持续保持高速增长.  
  
**[华东理工大学飞桨领航团](https://www.paddlepaddle.org.cn/ppdenavigategroup) - 团长 - (2021.4-2022.1)**
* **从零搭建华东理工大学飞桨领航团**, 围绕飞桨推广与应用, 面向未来 AI 开发者设计 AI 趣味游戏、知识竞赛、主题讲座、实操挑战赛、项目体验等多元活动形态, 持续扩大活跃成员规模、夯实人工智能与深度学习实战能力, 助力学校 AI 体系化人才培养建设.
* 任期内累计举办**5+**场活动、覆盖**100+**人次、**孵化 10+ 个精品项目**, **推动「教育部产学合作协同育人项目(百度公司 & 华东理工大学)」课程建设落地应用**.  
  
**华东理工大学信息学院社团管理部 - 顾问 - (2019.10~2020.6)**
* 统筹学院 10+ 学生社团协同运作, 搭建社团与院团委的常态化沟通机制, 推动"社团招新"、"新人培训"等活动落地. 主导院级活动"班歌班标大赛"组织筹划, 牵头各班级活动视频拍摄与质量审核、舞美布置与人员协调.
* 主持五大学院联合活动"社团交流会"全流程组织: 前期统筹邀请函制作与派发、活动期间担任主持人完成主持串场、结束后撰写复盘总结.  
