...
**Results**:
* Released [Xinyuan-VL-2B](https://huggingface.co/Cylingo/Xinyuan-VL-2B), which ranked first on [OpenCompass](https://huggingface.co/spaces/opencompass/open_vlm_leaderboard) in the under-4B parameter category at the time.
...
**[Health LLM Knowledge Platform](https://github.com/X-D-Lab)**
...
**Results**: Incubated [Sunsimiao](https://github.com/X-D-Lab/Sunsimiao) medical LLM (400+ Stars) and [MindChat](https://github.com/X-D-Lab/MindChat) mental health LLM (700+ Stars). Connected model capabilities to WeChat via [OXiaoPeng](https://github.com/thomas-yanxin/OXiaoPeng), reaching **2,000+ direct users** and **20,000+ indirect users**.

**[ColugoMum: Smart Retail Settlement Platform](https://github.com/thomas-yanxin/Smart_container)**
...
**[OXiaoPeng](https://github.com/thomas-yanxin/OXiaoPeng)**
...
Reach me at [yx20001210@163.com](mailto:yx20001210@163.com) or on [GitHub](https://github.com/thomas-yanxin).
